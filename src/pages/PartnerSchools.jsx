...
export const PartnerSchoolsPage = () => {
              ...
              schools.map( (item , index) => (
                  <div className='shadow-lg relative animate-[bottomToTop_1.5s_ease-in-out] left-to-right  mx-3' key={index}>
                          ...
                          <div className='mt-3  p-3  md:ml-0'>
                              ...
                              {item?.Formations && (
                                <div className='my-4'>
                                  <strong className='block mb-2 '>Formations</strong>
                                  {
                                    item.Formations.map((formation , index) => (
                                      <span className="bg-slate-100 text-slate-500 mr-2 px-2 rounded" key={index}>{formation.label}</span>
                                    ))
                                  }
                                </div>
                              )}
